...
const Empty = () => {
    return (
        <div className='py-24 text-center space-y-4'>
            ...
            <p className='mb-8 text-xl text-gray-900 md:text-2xl'>Browse,Search,Add To Cart,Favorite</p>
            <Link to='/'>
    ...
    <span classN="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-gray-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
</button>
            </Link>
        </div>
    );
